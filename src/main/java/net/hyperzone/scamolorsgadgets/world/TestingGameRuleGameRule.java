...
public class TestingGameRuleGameRule extends ScamolorsGadgetsModElements.ModElement {
	public static final GameRules.RuleKey<GameRules.BooleanValue> gamerule = GameRules.register("testingGameRule", GameRules.Category.PLAYER,
			create(true));
