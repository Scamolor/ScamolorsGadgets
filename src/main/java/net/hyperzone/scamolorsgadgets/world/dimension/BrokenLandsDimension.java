...
package net.hyperzone.scamolorsgadgets.world.dimension;
...
import net.hyperzone.scamolorsgadgets.item.BrokenLandsItem;
import net.hyperzone.scamolorsgadgets.block.BrokenBlock;
...
public class BrokenLandsDimension extends ScamolorsGadgetsModElements.ModElement {
	@ObjectHolder("scamolors_gadgets:broken_lands_portal")
	public static final CustomPortalBlock portal = null;

	public BrokenLandsDimension(ScamolorsGadgetsModElements instance) {
		super(instance, 75);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(BrokenBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("scamolors_gadgets:you_shouldnt_be_here")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("scamolors_gadgets:broken_lands"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("broken_lands_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("broken_lands_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0,
					1).setRegistryName("broken_lands_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new BrokenLandsItem().setRegistryName("broken_lands"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("broken_lands_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("scamolors_gadgets:broken_lands"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("scamolors_gadgets:broken_lands")));
				} else {
					entity.func_242279_ag();
