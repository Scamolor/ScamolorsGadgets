...
import net.hyperzone.scamolorsgadgets.entity.renderer.CrystalStaffRenderer;
...
public class CrystalStaffItem extends ScamolorsGadgetsModElements.ModElement {
	@ObjectHolder("scamolors_gadgets:crystal_staff")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ScamolorGadgetsItemGroup.tab).maxDamage(100));
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Test item"));
		}
